...
#: API token. Used for the org audit event log (product-access grants/revokes),
#: which the site token cannot provide. Optional; the tool works without it.
...
# --------------------------------------------------------------------------
# organisation (admin) API key — optional, separate secret (org audit events)
# --------------------------------------------------------------------------
